...
class WithLossCell(nn.Cell):
    ...
    def construct(self, x, img_shape, gt_bboxe, gt_label, gt_num):
        loss1, loss2, loss3, loss4, loss5, loss6, loss7, loss8, loss9 = self._backbone(x, img_shape,
                                                                                gt_bboxe, gt_label, gt_num)
        return self._loss_fn(loss1, loss2, loss3, loss4, loss5, loss6, loss7, loss8, loss9)
