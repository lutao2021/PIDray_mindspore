...
config = ed({
    ...
    "mindrecord_dir": "./mr_pid/",
    "coco_root": "/mnt/pidray-test2",
    "train_data_type": "xray_train",
    "val_data_type": "xray_test",
    "instance_set": "annotations/{}_with_bg.json",
    "coco_classes": ('background', 'Baton', 'Pliers', 'Hammer', 'Powerbank', 'Scissors', 'Wrench', 'Gun', 'Bullet',
